...
return [
    ...
    //短信使用场景
    'SEND_SCENE' => array(
        '1'=>array('用户注册','验证码${code}，您正在注册成为${product}用户，感谢您的支持!'),
        '2'=>array('用户找回密码','验证码${code}，用于密码找回，如非本人操作，请及时检查账户安全'),
        '3'=>array('客户下单','您有新订单，收货人：${consignee}，联系方式：${phone}，请您及时查收.'),
        '4'=>array('客户支付','订单:${order_sn}已经支付，请及时发货.'),
        '5'=>array('商家发货','尊敬的${user_name}用户，您的订单${order_sn}已发货，收货人${consignee}，请您及时查收'),                          
        '6'=>array('修改手机号码','尊敬的${user_name}用户，验证码${code}, 您正在修改/绑定手机号码, 打死不要告诉别人.'),
    ),
